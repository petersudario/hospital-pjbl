<html>
    ...
    ?>
        ...
        <form name="form1" id="form1" method="post" action="./paciente_create_php.php" class="max-w-md mx-auto">
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="txtCondicao" id="txtCondicao" value="<?php ?>" class="w-full px-4 py-2 border border-gray-300 rounded-md">
            </div>
            <div class="mb-4">
